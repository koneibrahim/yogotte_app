<?php
 ...
 echo'<div id="contvert">';
           ...
           echo'<tr>';
           echo'<td class="textcen"><a href="Amodifier.php?id_ve='.$id_ve.
               ...
               <img src="/Images/imprim.png" width="35px"height="35px" class="img" title="Imprimé"></a>';
                //   if($ligne['etat']==0) {
               echo'<a href="Asupprimer.php?id_ve='.$ligne['id_ve'].
               '&date_vec='.$ligne['date_ve'].'&libele='.$ligne['libele'].'">
        ...
        //   if($ligne['etat']==0) {
           ...
           echo'<td colspan="2" class="textgau"><a href="listeliv.php?id_ve='.$id_ve.
               ...
               echo'</tr>';
           echo'<tr>';
           echo'<td colspan="2"  class="textgau"><a href="payement.php?id_ve='.$id_ve.
               '&date_ve='.$ligne['date_ve'].
               '&libele='.$ligne['libele'].
               '&etat='.$ligne['etat'].
